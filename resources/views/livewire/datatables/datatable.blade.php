<div>
    ...
    <div class="relative">
        ...
        @unless($this->hidePagination)
            <div class="max-w-screen bg-white @unless($complex) rounded-b-lg @endunless border-4 border-t-0 border-b-0 border-transparent">
    ...
    @if($complex)
        <div class="bg-gray-50 px-4 py-4 rounded-b-lg rounded-t-none shadow-lg border-2 border-transparent @if($complex) border-t-0 @endif">
